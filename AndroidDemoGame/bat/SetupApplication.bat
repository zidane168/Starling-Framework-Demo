...
:: Android packaging
set AND_CERT_NAME="AndroidDemoNew"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\AndroidDemoNew.p12
...
set IOS_PROVISION=cert\AndroidDemoNew.mobileprovision
